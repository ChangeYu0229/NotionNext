...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '老于', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '《你今天AI了吗》栏目作者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://candy666.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI,人工智能,ChatGPT,Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'aidenyu0229@gmail.com', // 邮箱地址 例如mail@tangly1024.com
